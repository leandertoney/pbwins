...
export async function extractFirstMatchDate(page) {
  ...
  try {
    ...
    const maxScrollAttempts = 8; // Reduced to 8 to prevent Browserless timeout for players with many matches
    const maxScrollTime = 15000; // Maximum 15 seconds for scrolling
