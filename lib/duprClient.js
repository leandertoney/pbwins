...
/**
 * Load cookies from file (local dev only)
 * In production on Netlify: cookies won't persist, so we login fresh each time
 */
async function loadCookies() {
  try {
    ...
    console.log('No cookies found - will perform fresh login');
    return null;
  }
}
