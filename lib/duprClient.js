...
export async function extractFirstMatchDate(page) {
  ...
  const maxScrollAttempts = 15; // Reduced to prevent Browserless timeout (was 50)
  ...
  // If we hit max attempts, we may not have all matches but that's okay
  if (scrollAttempts >= maxScrollAttempts) {
    console.log('✓ Loaded sample of matches (reduced to avoid timeout)');
  }
