 ...
 * 5. Updates the DB
 *
 * Usage: NEXT_PUBLIC_CONVEX_URL=https://next-viper-38.convex.cloud node scripts/backfillVerifiedSince.mjs
 */

import { ConvexHttpClient } from "convex/browser";
import { api } from "../convex/_generated/api.js";
import { getEarliestMatch } from "../lib/dupr/getEarliestMatch.mjs";
